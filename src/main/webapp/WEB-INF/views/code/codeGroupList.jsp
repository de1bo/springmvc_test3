...
<c:choose>
	...
	<c:otherwise>
		...
		<c:out value="${item.ifcgSeq}"/> | <a href="/infra/code/codeGroupView?ifcgSeq=${item.ifcgSeq}"><c:out value="${item.ifcgName}"/>|<c:out value="${item.delNy}"/>|<c:out value="${item.ifcgeEng}"/><br>
